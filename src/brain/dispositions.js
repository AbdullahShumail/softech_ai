...
export const DISPOSITIONS = {
  ...
  NEU: { desc: "Neutral, or ANSWERS the website-age question with an age — \"5 years\", \"since 2019\", \"a while back\", \"go on\", \"okay\"", group: 'advance' },
  NOSITE: { desc: "Says they have NO website at all — \"we don't have one\", \"no website\", \"never had a site\", \"just a Facebook page\"", group: 'advance' },
  ...
  BUDGET: { desc: "Cost objection, dismissive — \"too expensive\", \"no budget\", \"can't afford it\", \"we're not spending on that\"", group: 'objection' },
  SMALL: { desc: "Too small to need it — \"we're a small shop\", \"all our work is word of mouth\", \"we don't sell online\"", group: 'objection' },
  THINK: { desc: "Stalling rather than refusing — \"let me think about it\", \"I'll discuss it with my partner\", \"maybe later on\"", group: 'objection' },
  ...
  PRICE: { desc: "Genuine price question, wants a real number — \"how much does it cost\", \"what's your rate\", \"what would that run me\"", group: 'question' },
  PROOF: { desc: "Wants credibility — \"who have you worked with\", \"is this legit\", \"is this a scam\", \"do you have a website\"", group: 'question' },
